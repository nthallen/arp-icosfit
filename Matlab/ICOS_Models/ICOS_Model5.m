classdef ICOS_Model5 < opt_model_p
  ...
  methods
    function PM = ICOS_Model5(P,varargin)
  ...
  methods (Static)
    ...
    function M = P_model(P)
      ...
      if P.stop_ICOS
        M.Optic{3} = HRmirror('M2', P.r, P.RC, CT, T, 0, [d 0 0], [-1 0 0], n_ZnSe, n_air, P.visible && visibility(3));
      else
